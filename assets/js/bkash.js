...
var messagesRef = firebase.database().ref('Bkash Payments');
...
function submitForm(e){
  ...
  var bkash_number = getInputVal('bkash_number');
  ...
  // Save message
  saveMessage(owner_name, bkash_number, transection_id,transection_date,amount );
...
function saveMessage(owner_name, bkash_number, transection_id,transection_date,amount){
